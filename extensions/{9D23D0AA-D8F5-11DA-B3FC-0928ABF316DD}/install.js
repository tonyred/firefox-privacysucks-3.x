...
var XpiInstaller = {
  ...
  extFullName    : 'CookieSafe', // The name displayed to the user (don't include the version)
  extShortName   : 'cookiesafe', // The leafname of the JAR file (without the .jar part)
  extVersion     : '3.0.5',
  extAuthor      : 'Ron Beckman',
  extLocaleNames : ['en-US','bg-BG','de-DE','es-ES','fr-FR','hu-HU','it-IT','ja-JP','ko-KR','nl-NL','pl-PL','pt-BR','ru-RU','uk-UA','zh-CN'],
  extSkinNames   : ['classic'], // e.g., ['classic','modern']
  extPreferences : ['cookiesafe.js'], // e.g., ['extension.js']
  extComponents  : ['nsCookieSafe.js','nsCS3rdPartyHosts.js','nsCS3rdPartyObserver.js','nsCSCookieObserver.js','nsCSHiddenMenuItems.js','nsCSHttpObserver.js','nsCSLast10Hosts.js','nsCSPermManager.js','nsCSShutdownObserver.js','nsCSTempExceptions.js','nsICookieSafe.xpt','nsICS3rdPartyHosts.xpt','nsICSHiddenMenuItems.xpt','nsICSLast10Hosts.xpt','nsICSPermManager.xpt','nsICSTempExceptions.xpt'],
